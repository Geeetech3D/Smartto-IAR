#ifndef __Configuration_GTM32_Pro_A30D_H__  
#define __Configuration_GTM32_Pro_A30D_H__
#include "Configuration_Select_Printer.h"


#define DEVICE_NAME "GEEETECH-A30D"     //Device name
#define MACHINE_TYPE "A30D"                   //Equipment model
