...
#define K1 0.95
  ...
  #define SET_FAN0_SPEED(power)         TIM_SetCompare2(TIM4,power)     //FAN0_PWM
  #define SET_FAN1_SPEED(power)         TIM_SetCompare3(TIM4,power)     //FAN1_PWM
  #define SET_FAN2_SPEED(power)         TIM_SetCompare4(TIM4,power)     //FAN2_PWM
