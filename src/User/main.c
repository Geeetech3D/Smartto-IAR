...
extern u8 Firmware_Updata_Flag,S3D_Touch_Flag;
...
void Get_Store_Date(void)
{
    ...
    system_infor.Auto_Levele_3dTouch_Flag=Get_AutoLevele_3DTouch_Flag();
    if(system_infor.Auto_Levele_3dTouch_Flag ==1)
            S3D_Touch_Flag=1;
    else
            S3D_Touch_Flag=0;
